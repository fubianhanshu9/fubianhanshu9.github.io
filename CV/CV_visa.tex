...
\begin{document}
	...
	\NewPart{EXPERIENCE}{}
	\begin{itemize}
		\item Research Assistant (soon to be a postdoctoral researcher), The Hong Kong University of Science and Technology (Guangzhou), 2025.3-now.
	...
	%{\begin{itemize}
		...
		%\EducationEntry{Título trabajo 1}{Periodo}{Empresa}{
			...
			\vspace{5cm}
			\centering{\emph{Last updated on April 24, 2025}} 
		\end{document}