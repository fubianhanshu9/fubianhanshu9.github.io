...
\PersonalEntry{Address:}{393 Middle Huaxia Road, Shanghai 201210, China}
%\PersonalEntry{Address}{111 First St, New York}
\PersonalEntry{Website:}{http://faculty.sist.shanghaitech.edu.cn/faculty/boris/michael.html}
...
\EducationEntry{University of Chinese Academy of Sciences\\Shanghai Institute of Microsystem and Information Technology, Chinese Academy of Sciences\\ShanghaiTech University}{Sep.2017-Sep.2022}{Ph.D,  Communication and Information Systems Engineering (Supervised by Professor Boris Houska)}
%{\begin{itemize}
%\item{Especialidad }
...
=======
	...
	%\MyName{Xu Du}
	%\MySlogan{Nombre de tu carrera}
>>>>>>> 24c0509eb6ebf2e75ce81a4314aa5c614e0d016c
	...
	\NewPart{EXPERIENCE}
	\begin{itemize}
		\item Assistant Researcher, Institute of Mathematics HNAS, Henan Academy of Science, 2023.7-now.
	...
	\EducationEntry{University of Chinese Academy of Sciences\\Shanghai Institute of Microsystem and Information Technology, Chinese Academy of Sciences}{Sep.2017-Sep.2022}{Ph.D.  in  Communication and Information Systems Engineering (Supervised by Professor Boris Houska)}
	%{\begin{itemize}
			%\item{Especialidad }
			%\item{Asignaturas más relevantes de carrera/especialidad}
			%\item{Proyecto de fin de carrera: \emph{título del proyecto}}
