...
\NewPart{EXPERIENCE}{}
\begin{itemize}
		\item Postdoctoral Researcher, Artificial Intelligence Thrust, Information Hub, The Hong Kong University of Science and Technology (Guangzhou), 2025.5-now. (Supervised by Apostolos Rikos)
...
%\section{Conference}
\begin{itemize}
		\item [\textbf{C15}] {\textbf{X.Du}, Boyu Han,  K. H. Johansson,  A. I. Rikos$^*$   \\
		...
		\item [\textbf{C14}] {Yifei Wang, Xuhui Feng, Shimin Pan, Liangfan Zhu, \textbf{X.Du}$^*$,  A. I. Rikos   \\
		{Lightweight Real-Time ALADIN for Distributed Optimization.}\\
		\emph{The 23rd IFAC World Congress, Busan, South Korea, 2026. (accepted)
	} }
	
		\item [\textbf{C13}] {Boyu Han, \textbf{X.Du}, K. H. Johansson,  A. I. Rikos$^*$ \\
...
\vspace{2cm}
\centering{\emph{Last updated on April  15, 2026}} 
\end{document}